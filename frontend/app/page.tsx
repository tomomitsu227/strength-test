// frontend/app/page.tsx - 改善版（質問速度UP・番号表示・ヒーロー縦・レーダーチャート）
'use client';
          ...
          >
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
              ...
              <div className="mb-8 max-w-md mx-auto">
                <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">🎯 あなたの性格分析</h3>
              ...
              <div className="bg-blue-50 p-8 rounded-2xl mb-8 border-2 border-blue-200">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">📋 診断結果の総合評価</h3>
                <p className="text-gray-700 leading-relaxed whitespace-pre-line">{result.overall_summary}</p>
              </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="text-center mb-4">
              <span className="text-xl font-bold text-red-500">Q{currentQuestion + 1}</span>
              <span className="text-gray-400 text-lg"> / 20</span>
            </div>
            
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 leading-relaxed text-center">{currentQ.q}</h2>
